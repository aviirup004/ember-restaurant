...
files.forEach(file => {
  ...
  // 1. Replace section backgrounds with bg-transparent
  content = content.replace(/bg-black\/\d+/g, 'bg-transparent');
  content = content.replace(/bg-\[#080808\]/g, 'bg-transparent');
  // Also fix footer background
